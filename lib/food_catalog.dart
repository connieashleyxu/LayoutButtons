...
class FoodCatalog extends StatelessWidget{
  const FoodCatalog({Key? key, required List<Food> foods}) : super(key: key);

  // Constructor
  //FoodCatalog({Key? key, required this.foods}) : super(key: key);
...
class MyStatefulWidget extends StatefulWidget {
  ...
  // Stateful Widget
  @override
  State<MyStatefulWidget> createState() => _FoodCatalogState();
}
...
//
//   @override
//   State<MyStatefulWidget> createState() => FoodCatalog(foods: []);
// }

class _FoodCatalogState extends State<MyStatefulWidget> {
//class FoodCatalog extends State<MyStatefulWidget> {
  // Instance Variables
  var foods = <Food>[];
  int _count = 0;
                ...
                children: [
                  ...
                  Align(
                    ...
                    child: SizedBox(
                      ...
                      child: Image(
                        image: NetworkImage(foods[_count].url),
                        fit: BoxFit.cover,
                      ),
                    ),
                  ),
